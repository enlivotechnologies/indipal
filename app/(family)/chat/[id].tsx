  ...
  return (
    <View style={{ flex: 1, backgroundColor: 'white' }}>
      ...
      >
        ...
        >
          <TouchableOpacity onPress={() => router.replace('/(family)/chat' as any)} className="mr-4">
          ...
          <TouchableOpacity
            onPress={() => {
              Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Medium);
              router.push({
                pathname: '/(family)/chat/contact-profile',
          ...
          >
            <View className="w-10 h-10 bg-orange-50 rounded-2xl items-center justify-center border border-orange-100 overflow-hidden">
              {conversation.contactAvatar ? (
                ...
                <Ionicons name="person" size={20} color={BRAND_ORANGE} />
              )}
            </View>
          ...
          <View className="flex-row gap-x-3">
            ...
            >
              <Ionicons name="call" size={18} color={BRAND_ORANGE} />
            </TouchableOpacity>
        ...
        {showAttachments && (
          <View className="px-6 py-6 bg-gray-50 border-t border-gray-100 flex-row justify-between">
            ...
            <AttachmentItem icon="location" label="Location" color={BRAND_ORANGE} onPress={handleLocation} />
        ...
        {isBlocked ? (
          ...
          >
            ...
            <TouchableOpacity
              ...
              disabled={isSending}
              style={{
                backgroundColor: (inputText.trim() || isRecording) ? BRAND_ORANGE : '#E5E7EB'
              }}
...
const MessageItem = React.memo(({ msg, isMe, contactName }: { msg: any, isMe: boolean, contactName: string }) => {
  ...
  return (
    <View className={`mb-6 flex-row ${isMe ? 'justify-end' : 'justify-start'}`}>
      <View
        style={{
          backgroundColor: isMe ? BRAND_ORANGE : '#F3F4F6'
        }}
      ...
      >
        ...
        {msg.type === 'location' && (
          ...
          >
            <Ionicons name="map" size={20} color={isMe ? 'white' : BRAND_ORANGE} />
      ...
      <View className="flex-1">
        <View className={`h-1 w-full rounded-full ${isMe ? 'bg-white/30' : 'bg-gray-200'}`}>
          <View
            style={{
              width: `${position * 100}%`,
              backgroundColor: isMe ? '#FFFFFF' : BRAND_ORANGE
            }}

...
export default function FamilyHomeScreen() {
  ...
  const pendingGrocery = gigs.find(
    (g) => g.status === "pending_approval" && g.category === "Grocery",
  );
  ...
  const handleRefillImmediately = (med: Medication) => {
    ...
    Alert.alert(
      "Errand Created",
      "A refill request has been sent to nearby Pals.",
    );
  };

  const pendingMedReview = medications.find(
    (m) => m.status === "pending_review",
  );

  const activeTab = pathname.includes("home")
    ? "Home"
  ...
  const services = [
    ...
    },
    {
      ...
      route: "/(family)/services/house-help",
    },
    {
      id: "3",
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "white" }}>
      ...
      {activeSOS && (
        <Animated.View
          entering={FadeInUp}
          className="bg-red-600 mt-2 mx-4 rounded-3xl overflow-hidden shadow-2xl shadow-red-200"
        >
          <LinearGradient colors={["#DC2626", "#B91C1C"]} className="p-5">
              ...
              <View className="flex-row items-center flex-1">
                ...
                <View className="ml-4 flex-1">
                  ...
                  <Text className="text-white/80 text-[10px] font-bold uppercase tracking-widest">
                    {activeSOS.seniorName} Needs help!
                  </Text>
                </View>
              </View>
              <TouchableOpacity
            ...
            <View className="mt-4 pt-4 border-t border-white/10 flex-row items-center justify-between">
              <View className="flex-row items-center">
                ...
                <Text className="text-white/90 text-[11px] font-bold ml-1.5">
                  {activeSOS.location}
                </Text>
              </View>
              <TouchableOpacity
              ...
              >
                ...
                <Text className="text-red-700 font-black text-[10px] uppercase tracking-widest ml-1.5">
                  Emergency Call
                </Text>
              </TouchableOpacity>
            </View>
      ...
      >
        ...
        <View className="flex-row items-center gap-x-2">
          ...
          <TouchableOpacity
            onPress={() =>
              router.push("/(family)/account/notifications" as any)
            }
            className="w-10 h-10 bg-gray-50 rounded-xl items-center justify-center border border-gray-100"
          >
      ...
      >
        ...
        >
          ...
          >
            <View className="flex-row justify-between items-start mb-6">
              ...
              <View
                className={`w-10 h-10 rounded-2xl items-center justify-center ${linkedSenior.hasSmartphone ? "bg-white/20" : "bg-orange-800/40"}`}
              >
                <Ionicons
                  name={
            ...
            <View className="bg-black/15 p-6 rounded-[24px] flex-row items-center">
              ...
              <Text
                className="text-white font-bold text-sm ml-4 flex-1"
                numberOfLines={1}
              >
                {linkedSenior.address}
              </Text>
            </View>
            ...
            {!linkedSenior.hasSmartphone && (
              <View className="mt-4 flex-row items-center">
                ...
                />
                <Text className="text-white/80 text-[10px] ml-2 italic">
                  Non-App User: Linked via VIP SMS/IVR fallback.
                </Text>
              </View>
            )}
          </LinearGradient>
        ...
        >
                ...
                Alert.alert(
                  ...
                  [
                    { text: "Cancel", style: "cancel" },
                    {
                      text: "Confirm",
                      onPress: () =>
                        updateMedicationStatus(pendingMedReview.id, "active"),
                    },
                  ],
                );
              }}
              ...
              <View className="flex-1 ml-4 pr-4">
                <View className="flex-row items-center justify-between mb-1">
                  ...
                  <View className="bg-amber-500 px-2 py-0.5 rounded-full">
                    <Text className="text-white text-[8px] font-black uppercase tracking-widest font-nunito">
                      Verify Now
                    </Text>
                  </View>
                </View>
                <Text
                  className="text-amber-800 text-[11px] leading-4"
                  numberOfLines={2}
                >
                  Review the prescription for {pendingMedReview.name} before
                  it&apos;s added to schedule.
                </Text>
              </View>
          ...
          {pendingGrocery ? (
            ...
            >
              ...
              <View className="flex-1 ml-4 pr-4">
                ...
                <Text
                  ...
                  numberOfLines={2}
                >
                  {pendingGrocery.seniorName} has requested{" "}
                  {pendingGrocery.items.length} items. Tap to approve and assign
                  a Pal.
                </Text>
              </View>
            ...
            <TouchableOpacity
              onPress={() =>
                router.push({
                  pathname: "/(family)/account/notifications",
                  params: { filter: "senior" },
                } as any)
              }
              className="bg-white p-6 rounded-[24px] border-2 border-orange-100 shadow-lg flex-row items-center"
            >
              <View
                style={{ backgroundColor: `${pendingOrder.color}20` }}
                className="w-12 h-12 rounded-2xl items-center justify-center border border-orange-100"
              >
                <Ionicons
                  name={pendingOrder.serviceIcon as any}
                  size={24}
              ...
              <View className="flex-1 ml-4 pr-4">
                <View className="flex-row items-center justify-between mb-1">
                  <Text className="text-gray-900 font-bold text-sm">
                    New {pendingOrder.serviceTitle} Request
                  </Text>
                ...
                <Text
                  ...
                  numberOfLines={2}
                >
                  {pendingOrder.seniorName} has requested{" "}
                  {pendingOrder.serviceTitle}. Tap to authorize payment of ₹
                  {pendingOrder.amount}.
                </Text>
              </View>
              <Ionicons name="chevron-forward" size={16} color="#F59E0B" />
            ...
            <View className="bg-white p-6 rounded-[24px] border border-gray-100 shadow-sm flex-row items-center opacity-60">
        ...
        >
          ...
          >
            <Image
              source={{
                uri: "https://images.unsplash.com/photo-1516733725897-1aa73b87c8e8?auto=format&fit=crop&q=80&w=400",
              }}
            ...
            >
              <View className="flex-row items-center justify-between mb-2">
                <View>
                  ...
                  <Text className="text-white/50 text-[10px] uppercase font-bold tracking-widest mt-1">
                    Managed by Arjun Singh
                  </Text>
                </View>
        ...
        <Text className="text-xs font-black text-gray-400 uppercase tracking-widest mb-4 ml-1">
          Live Monitoring
        </Text>
        <Animated.View
        ...
        >
          ...
          >
            ...
            <View className="p-6 flex-row items-center bg-white">
              <View className="flex-row items-center flex-1">
                <Image
                  source={{ uri: "https://i.pravatar.cc/100?u=arjun" }}
              ...
              >
                ...
                >
                  ...
                  <View className="flex-row items-center mt-1">
                    ...
                    <Text className="text-gray-400 text-[10px] font-black ml-1 uppercase">
                      {pal.rating} • {pal.experience}
                    </Text>
                  </View>
                </TouchableOpacity>
              </Animated.View>
        ...
        >
          <View className="flex-row items-center justify-between mb-4 px-1">
            ...
            <TouchableOpacity
              onPress={() =>
                router.push("/(family)/profiles/senior-health" as any)
              }
              className="bg-emerald-100 px-3 py-1.5 rounded-[24px] border border-emerald-200"
            >
              <Text className="text-[9px] text-emerald-700 font-black uppercase tracking-widest">
                Full Report
              </Text>
            </TouchableOpacity>
          </View>
          ...
          <View className="flex-row flex-wrap justify-between gap-y-4">
            <HealthStatusCard
              ...
              label="BP"
              value={
                healthRecords.bloodPressure
                  ? `${healthRecords.bloodPressure.systolic}/${healthRecords.bloodPressure.diastolic}`
                  : "--/--"
              }
              unit="mmHg"
              color="#EF4444"
            ...
            <HealthStatusCard
              ...
              unit={healthRecords.temperature?.unit || "°C"}
              color="#F59E0B"
              delay={300}
            />
          </View>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <Text className="text-white/50 text-[8px] font-black uppercase tracking-widest">
                      {service.subtitle}
                    </Text>
                  </LinearGradient>
                </TouchableOpacity>
          ...
          >
            <LinearGradient colors={["#1F2937", "#111827"]} className="p-8">
              ...
              <View className="flex-row justify-between items-center mb-8">
                <View>
                  <Text className="text-orange-400 text-[10px] font-black uppercase tracking-[3px] mb-1">
                    Care Wallet
                  </Text>
              ...
              <View className="flex-row items-end justify-between">
                <View>
                  <View className="flex-row items-baseline">
                    ...
                    <Text className="text-white/30 text-sm font-bold ml-2">
                      Total
                    </Text>
                  </View>
                  <View className="flex-row items-center mt-2">
                    <View className="w-2 h-2 bg-emerald-500 rounded-full mr-2 shadow-sm shadow-emerald-500" />
                    <Text className="text-emerald-400/80 text-[10px] font-black uppercase tracking-widest">
                      Auto-Refill Active
                    </Text>
                  </View>
                </View>
                ...
                >
                  <Text className="text-gray-900 font-black text-xs uppercase tracking-widest">
                    Add Funds
                  </Text>
                </TouchableOpacity>
              </View>
              ...
              <View className="flex-row items-center bg-white/5 p-4 rounded-[20px] border border-white/5">
                ...
                />
                <Text className="text-white/40 text-[9px] font-bold ml-3 uppercase tracking-widest">
                  Secured by Enlivo TrustShield
                </Text>
              </View>
            </LinearGradient>
          </TouchableOpacity>
        ...
        >
          ...
          >
            ...
            >
              ...
              <Text className="text-white font-nunito-bold ml-3 uppercase tracking-widest text-xs">
                Request Refill
              </Text>
            </TouchableOpacity>
            ...
            >
              ...
              <Text className="text-[#D97706] font-nunito-bold ml-3 uppercase tracking-widest text-xs">
                Add New Medicine
              </Text>
            </TouchableOpacity>
          </Animated.View>
      ...
      >
        <Ionicons
          name={plusMenuOpen ? "close" : "add"}
          size={plusMenuOpen ? 28 : 32}
          color="white"
        />
      </TouchableOpacity>
          ...
          <View className="bg-white rounded-t-[40px] p-8 max-h-[80%]">
            <View className="flex-row justify-between items-center mb-6">
              <View>
                ...
                <Text className="text-gray-900 font-nunito-bold text-2xl">
                  Select Medicine
                </Text>
              </View>
              <TouchableOpacity
                onPress={() => setRefillModal(false)}
                ...
                .map((med) => (
                  ...
                  >
                    ...
                    <View className="bg-orange-100 px-4 py-2 rounded-xl border border-orange-200">
                      <Text className="text-orange-700 text-[10px] font-black uppercase">
                        Refill
                      </Text>
                    </View>
                  </TouchableOpacity>
          ...
          <View className="bg-white rounded-t-[40px] p-8">
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
              <View className="gap-y-6 mb-10">
                <View>
                  <Text className="text-gray-900 font-black text-xs uppercase mb-3 ml-1 tracking-widest">
                    Medicine Name
                  </Text>
                  <TextInput
                    value={medName}
                ...
                <View className="flex-row gap-x-4">
                  ...
                  <View className="flex-1">
                    ...
                    <TouchableOpacity className="bg-gray-50 p-5 rounded-2xl border border-gray-100 items-center justify-center">
                      <Text className="font-nunito-bold text-lg text-gray-900">
                        {medFreq}
                      </Text>
                    </TouchableOpacity>
                  </View>
      ...
      >
        <View
          style={styles.tabBar}
          className="bg-gray-900/95 flex-row items-center h-16 rounded-[28px] px-2 shadow-2xl"
        >
          <TabButton
            icon="home"
            label="Home"
            ...
            {pendingGrocery && (
              ...
              >
                <View className="bg-orange-50 p-6 rounded-[32px] border border-orange-100 mb-8">
                  <Text className="text-orange-900 font-black text-xs uppercase mb-4 tracking-widest">
                    Requested Items
                  </Text>
                ...
                <View className="mb-8">
                  <Text className="text-gray-400 font-bold text-xs uppercase mb-4 tracking-widest ml-1">
                    Set Max Budget (₹)
                  </Text>
                  <View className="flex-row items-center bg-gray-50 p-6 rounded-[24px] border border-gray-100">
                    <Text className="text-gray-900 font-black text-xl mr-2">
                      ₹
                    </Text>
                    <TextInput
                      value={budget}
                ...
                <View className="bg-indigo-50 p-6 rounded-[32px] border border-indigo-100 flex-row items-center mb-8">
                  ...
                  <View className="ml-4 flex-1">
                    <Text className="text-indigo-900 font-black text-sm">
                      Enlivo Secure Pay
                    </Text>
                    <Text className="text-indigo-500 font-bold text-[10px] uppercase">
                      Garanteed from Wallet
                    </Text>
                  </View>
                </View>
                ...
                >
                  <Text className="text-white font-black text-lg uppercase tracking-widest font-nunito">
                    Confirm Order
                  </Text>
                </TouchableOpacity>
                <View className="h-10" />
  ...
  return (
    ...
    >
      <View className="flex-row items-center mb-4">
        ...
        <Text className="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-3">
          {label}
        </Text>
      </View>
      <View className="flex-row items-baseline">
        ...
        {unit && (
          <Text className="text-[9px] font-black text-gray-400 ml-1.5 uppercase">
            {unit}
          </Text>
        )}
      </View>
    ...
    <View className="flex-1 h-full items-center justify-center">
      ...
      >
        ...
        {active && (
          <Text
            numberOfLines={1}
            className="text-white text-[10px] font-bold ml-2 uppercase tracking-widest"
          >
            {label}
          </Text>
        )}

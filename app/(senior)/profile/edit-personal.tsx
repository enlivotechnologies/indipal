        ...
        <View style={{ flex: 1, backgroundColor: 'white' }}>
            ...
            >
                ...
                <View className="flex-1">
                    <Text className="text-2xl font-black text-gray-900">Personal Info</Text>
                    <Text className="text-xs font-bold text-gray-400 uppercase tracking-widest">Update basic details</Text>
                </View>
            </View>
            ...
            >
                ...
                >
                    <Animated.View entering={FadeInUp.delay(100)} className="mb-8">
                        <Text className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-3 ml-1">Full Name</Text>
                        <TextInput
                            value={form.name}
                    ...
                    <Animated.View entering={FadeInUp.delay(300)} className="mb-10">
                        <Text className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-3 ml-1">Residential Address</Text>
                        <TextInput
                            value={form.address}
                            ...
                            multiline
                            numberOfLines={4}
                            className="bg-gray-50 p-5 rounded-3xl border border-gray-100 font-bold text-gray-900 min-h-[120px]"
                    ...
                    >
                        <Text className="text-white font-black uppercase tracking-widest text-base">Save Changes</Text>
                    </TouchableOpacity>
                </ScrollView>
            </KeyboardAvoidingView>
        </View>
